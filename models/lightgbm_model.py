...
def forecast_and_nrmse(series_df: pd.DataFrame, test_fraction: float = 0.2) -> Tuple[float, pd.DataFrame, pd.DataFrame]:
    """
    Minimal LightGBM with lag features and recursive forecasting.
    ...
    try:
        ...
        # If features are constant or have too few unique values, fallback
        ...
        # Recursive multi-step forecast aligned to test horizon
